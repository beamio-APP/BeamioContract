...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioOracleInterface extends Interface {
  ...
  export interface IBeamioOracle extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioOracle;
    waitForDeployment(): Promise<this>;

    interface: IBeamioOracleInterface;
