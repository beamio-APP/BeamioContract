...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface BeamioQuoteHelperV07Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface BeamioQuoteHelperV07 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioQuoteHelperV07;
    waitForDeployment(): Promise<this>;

    interface: BeamioQuoteHelperV07Interface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    quoteUnitPointInUSDC6: TypedContractMethod<
      [cardCurrency: BigNumberish, unitPointPriceInCurrencyE18: BigNumberish, ],
      [bigint],
      'view'
    >
