...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioAccountFactoryV07Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'isBeamioAccount', data: BytesLike): Result;
  ...
  export interface IBeamioAccountFactoryV07 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioAccountFactoryV07;
    waitForDeployment(): Promise<this>;

    interface: IBeamioAccountFactoryV07Interface;
