...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IPaymasterV07Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'validatePaymasterUserOp', data: BytesLike): Result;
  ...
  export interface IPaymasterV07 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IPaymasterV07;
    waitForDeployment(): Promise<this>;

    interface: IPaymasterV07Interface;
