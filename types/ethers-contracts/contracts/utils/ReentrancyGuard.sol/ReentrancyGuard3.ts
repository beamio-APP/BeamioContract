...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface ReentrancyGuard3Interface extends Interface {
  ...
  export interface ReentrancyGuard3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ReentrancyGuard3;
    waitForDeployment(): Promise<this>;

    interface: ReentrancyGuard3Interface;
