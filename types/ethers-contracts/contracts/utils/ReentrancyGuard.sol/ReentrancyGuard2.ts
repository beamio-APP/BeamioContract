...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface ReentrancyGuard2Interface extends Interface {
  ...
  export interface ReentrancyGuard2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ReentrancyGuard2;
    waitForDeployment(): Promise<this>;

    interface: ReentrancyGuard2Interface;
