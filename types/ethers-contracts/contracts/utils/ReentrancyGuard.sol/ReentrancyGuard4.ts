...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface ReentrancyGuard4Interface extends Interface {
  ...
  export interface ReentrancyGuard4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ReentrancyGuard4;
    waitForDeployment(): Promise<this>;

    interface: ReentrancyGuard4Interface;
