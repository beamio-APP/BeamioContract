...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface Nonces4Interface extends Interface {
  ...
  export interface Nonces4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): Nonces4;
    waitForDeployment(): Promise<this>;

    interface: Nonces4Interface;
