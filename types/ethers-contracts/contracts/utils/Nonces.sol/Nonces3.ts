...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface Nonces3Interface extends Interface {
  ...
  export interface Nonces3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): Nonces3;
    waitForDeployment(): Promise<this>;

    interface: Nonces3Interface;
