...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface Nonces2Interface extends Interface {
  ...
  export interface Nonces2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): Nonces2;
    waitForDeployment(): Promise<this>;

    interface: Nonces2Interface;
