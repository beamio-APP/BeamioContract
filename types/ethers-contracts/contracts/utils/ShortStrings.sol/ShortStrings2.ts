...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface ShortStrings2Interface extends Interface {
  ...
  export interface ShortStrings2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ShortStrings2;
    waitForDeployment(): Promise<this>;

    interface: ShortStrings2Interface;
