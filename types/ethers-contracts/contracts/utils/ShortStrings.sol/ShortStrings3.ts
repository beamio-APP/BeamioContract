...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface ShortStrings3Interface extends Interface {
  ...
  export interface ShortStrings3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ShortStrings3;
    waitForDeployment(): Promise<this>;

    interface: ShortStrings3Interface;
