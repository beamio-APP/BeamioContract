...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface ShortStrings4Interface extends Interface {
  ...
  export interface ShortStrings4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ShortStrings4;
    waitForDeployment(): Promise<this>;

    interface: ShortStrings4Interface;
