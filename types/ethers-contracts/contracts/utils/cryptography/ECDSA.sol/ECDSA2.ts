...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../../common.js"
  ...
  export interface ECDSA2Interface extends Interface {
  ...
  export interface ECDSA2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ECDSA2;
    waitForDeployment(): Promise<this>;

    interface: ECDSA2Interface;
