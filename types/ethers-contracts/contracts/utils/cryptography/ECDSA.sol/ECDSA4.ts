...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../../common.js"
  ...
  export interface ECDSA4Interface extends Interface {
  ...
  export interface ECDSA4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ECDSA4;
    waitForDeployment(): Promise<this>;

    interface: ECDSA4Interface;
