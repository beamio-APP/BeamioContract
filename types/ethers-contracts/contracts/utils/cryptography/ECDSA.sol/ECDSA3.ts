...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../../common.js"
  ...
  export interface ECDSA3Interface extends Interface {
  ...
  export interface ECDSA3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ECDSA3;
    waitForDeployment(): Promise<this>;

    interface: ECDSA3Interface;
