...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../../common.js"
  ...
  export interface SafeCast4Interface extends Interface {
  ...
  export interface SafeCast4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): SafeCast4;
    waitForDeployment(): Promise<this>;

    interface: SafeCast4Interface;
