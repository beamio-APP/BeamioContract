...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../../common.js"
  ...
  export interface SafeCast3Interface extends Interface {
  ...
  export interface SafeCast3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): SafeCast3;
    waitForDeployment(): Promise<this>;

    interface: SafeCast3Interface;
