...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../../common.js"
  ...
  export interface SafeCast2Interface extends Interface {
  ...
  export interface SafeCast2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): SafeCast2;
    waitForDeployment(): Promise<this>;

    interface: SafeCast2Interface;
