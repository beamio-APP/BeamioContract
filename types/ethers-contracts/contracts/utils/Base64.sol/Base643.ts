...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface Base643Interface extends Interface {
  ...
  export interface Base643 extends BaseContract {
    
    connect(runner?: ContractRunner | null): Base643;
    waitForDeployment(): Promise<this>;

    interface: Base643Interface;
