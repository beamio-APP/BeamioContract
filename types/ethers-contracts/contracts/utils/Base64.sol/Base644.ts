...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface Base644Interface extends Interface {
  ...
  export interface Base644 extends BaseContract {
    
    connect(runner?: ContractRunner | null): Base644;
    waitForDeployment(): Promise<this>;

    interface: Base644Interface;
