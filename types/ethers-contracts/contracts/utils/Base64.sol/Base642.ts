...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface Base642Interface extends Interface {
  ...
  export interface Base642 extends BaseContract {
    
    connect(runner?: ContractRunner | null): Base642;
    waitForDeployment(): Promise<this>;

    interface: Base642Interface;
