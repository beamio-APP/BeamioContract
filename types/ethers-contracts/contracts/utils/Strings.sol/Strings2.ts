...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface Strings2Interface extends Interface {
  ...
  export interface Strings2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): Strings2;
    waitForDeployment(): Promise<this>;

    interface: Strings2Interface;
