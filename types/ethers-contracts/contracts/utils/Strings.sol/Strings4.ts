...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface Strings4Interface extends Interface {
  ...
  export interface Strings4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): Strings4;
    waitForDeployment(): Promise<this>;

    interface: Strings4Interface;
