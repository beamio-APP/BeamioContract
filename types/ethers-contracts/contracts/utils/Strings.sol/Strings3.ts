...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../common.js"
  ...
  export interface Strings3Interface extends Interface {
  ...
  export interface Strings3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): Strings3;
    waitForDeployment(): Promise<this>;

    interface: Strings3Interface;
