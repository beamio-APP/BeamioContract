...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../../../common.js"
  ...
  export interface ERC1155Burnable3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'uri', data: BytesLike): Result;
  ...
  export interface ERC1155Burnable3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ERC1155Burnable3;
    waitForDeployment(): Promise<this>;

    interface: ERC1155Burnable3Interface;
