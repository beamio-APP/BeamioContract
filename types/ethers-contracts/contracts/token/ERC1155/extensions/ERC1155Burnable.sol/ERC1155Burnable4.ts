...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../../../../common.js"
  ...
  export interface ERC1155Burnable4Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'uri', data: BytesLike): Result;
  ...
  export interface ERC1155Burnable4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ERC1155Burnable4;
    waitForDeployment(): Promise<this>;

    interface: ERC1155Burnable4Interface;
