...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../../common.js"
  ...
  export interface IERC1155Receiver3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'supportsInterface', data: BytesLike): Result;
  ...
  export interface IERC1155Receiver3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IERC1155Receiver3;
    waitForDeployment(): Promise<this>;

    interface: IERC1155Receiver3Interface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    onERC1155BatchReceived: TypedContractMethod<
      [operator: AddressLike, from: AddressLike, ids: BigNumberish[], values: BigNumberish[], data: BytesLike, ],
      [string],
      'nonpayable'
    >
    ...
    onERC1155Received: TypedContractMethod<
      [operator: AddressLike, from: AddressLike, id: BigNumberish, value: BigNumberish, data: BytesLike, ],
      [string],
      'nonpayable'
    >
