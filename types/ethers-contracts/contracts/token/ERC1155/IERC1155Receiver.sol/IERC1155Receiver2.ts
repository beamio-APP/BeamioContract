...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../../common.js"
  ...
  export interface IERC1155Receiver2Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'supportsInterface', data: BytesLike): Result;
  ...
  export interface IERC1155Receiver2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IERC1155Receiver2;
    waitForDeployment(): Promise<this>;

    interface: IERC1155Receiver2Interface;
