...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface IRedeemModuleInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'createRedeem', data: BytesLike): Result;
  ...
  export interface IRedeemModule extends BaseContract {
    
    connect(runner?: ContractRunner | null): IRedeemModule;
    waitForDeployment(): Promise<this>;

    interface: IRedeemModuleInterface;
