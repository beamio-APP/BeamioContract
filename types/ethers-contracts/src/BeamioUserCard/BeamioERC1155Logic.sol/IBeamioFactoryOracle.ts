...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../common.js"
  ...
  export interface IBeamioFactoryOracleInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'quoteUnitPointInUSDC6', data: BytesLike): Result;
  ...
  export interface IBeamioFactoryOracle extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioFactoryOracle;
    waitForDeployment(): Promise<this>;

    interface: IBeamioFactoryOracleInterface;
