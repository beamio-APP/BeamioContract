...
export declare namespace LibStatsStorage {
  ...
  export interface StatsFacet3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'recordDetailedActivityAt', data: BytesLike): Result;
  ...
  export interface StatsFacet3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): StatsFacet3;
    waitForDeployment(): Promise<this>;

    interface: StatsFacet3Interface;
