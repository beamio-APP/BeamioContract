...
export declare namespace LibStatsStorage {
  ...
  export interface StatsFacet4Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'recordDetailedActivityAt', data: BytesLike): Result;
  ...
  export interface StatsFacet4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): StatsFacet4;
    waitForDeployment(): Promise<this>;

    interface: StatsFacet4Interface;
