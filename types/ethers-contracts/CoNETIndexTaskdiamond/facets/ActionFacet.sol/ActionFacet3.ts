...
export declare namespace ActionFacet {
  ...
  export interface ActionFacet3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'syncTokenAction', data: BytesLike): Result;
  ...
  export interface ActionFacet3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): ActionFacet3;
    waitForDeployment(): Promise<this>;

    interface: ActionFacet3Interface;
