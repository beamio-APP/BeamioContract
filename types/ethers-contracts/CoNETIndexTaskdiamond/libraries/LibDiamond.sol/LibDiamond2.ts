...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../../../common.js"
  ...
  export interface LibDiamond2Interface extends Interface {
  ...
  export interface LibDiamond2 extends BaseContract {
    
    connect(runner?: ContractRunner | null): LibDiamond2;
    waitForDeployment(): Promise<this>;

    interface: LibDiamond2Interface;
