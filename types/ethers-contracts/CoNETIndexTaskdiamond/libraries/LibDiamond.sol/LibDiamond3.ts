...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../../../common.js"
  ...
  export interface LibDiamond3Interface extends Interface {
  ...
  export interface LibDiamond3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): LibDiamond3;
    waitForDeployment(): Promise<this>;

    interface: LibDiamond3Interface;
