...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener } from "../../common.js"
  ...
  export interface BeamioIndexerDiamond3Interface extends Interface {
  ...
  export interface BeamioIndexerDiamond3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioIndexerDiamond3;
    waitForDeployment(): Promise<this>;

    interface: BeamioIndexerDiamond3Interface;
