...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioDeployerV074Interface extends Interface {
  ...
  export interface IBeamioDeployerV074 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioDeployerV074;
    waitForDeployment(): Promise<this>;

    interface: IBeamioDeployerV074Interface;
