...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioQuoteHelper4Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'quoteUnitPointInUSDC6', data: BytesLike): Result;
  ...
  export interface IBeamioQuoteHelper4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioQuoteHelper4;
    waitForDeployment(): Promise<this>;

    interface: IBeamioQuoteHelper4Interface;
