...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioRedeemModuleVNext4Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'terminateRedeemPool', data: BytesLike): Result;
  ...
  export interface IBeamioRedeemModuleVNext4 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioRedeemModuleVNext4;
    waitForDeployment(): Promise<this>;

    interface: IBeamioRedeemModuleVNext4Interface;
