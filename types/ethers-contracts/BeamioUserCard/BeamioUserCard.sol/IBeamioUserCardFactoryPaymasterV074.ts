...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioUserCardFactoryPaymasterV074Interface extends Interface {
  ...
  export interface IBeamioUserCardFactoryPaymasterV074 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioUserCardFactoryPaymasterV074;
    waitForDeployment(): Promise<this>;

    interface: IBeamioUserCardFactoryPaymasterV074Interface;
