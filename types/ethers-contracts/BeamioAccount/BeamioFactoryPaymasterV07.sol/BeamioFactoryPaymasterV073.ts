...
export declare namespace IBeamioContainerModuleV07 {
  ...
  export interface BeamioFactoryPaymasterV073Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'withdrawTo', data: BytesLike): Result;
  ...
  export interface BeamioFactoryPaymasterV073 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioFactoryPaymasterV073;
    waitForDeployment(): Promise<this>;

    interface: BeamioFactoryPaymasterV073Interface;
