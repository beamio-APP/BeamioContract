...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioUserCardLike3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'pointsUnitPriceInCurrencyE6', data: BytesLike): Result;
  ...
  export interface IBeamioUserCardLike3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioUserCardLike3;
    waitForDeployment(): Promise<this>;

    interface: IBeamioUserCardLike3Interface;
