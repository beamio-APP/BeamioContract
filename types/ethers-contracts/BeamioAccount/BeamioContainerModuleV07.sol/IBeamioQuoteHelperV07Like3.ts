...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioQuoteHelperV07Like3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'quoteUnitPointInUSDC6', data: BytesLike): Result;
  ...
  export interface IBeamioQuoteHelperV07Like3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioQuoteHelperV07Like3;
    waitForDeployment(): Promise<this>;

    interface: IBeamioQuoteHelperV07Like3Interface;
