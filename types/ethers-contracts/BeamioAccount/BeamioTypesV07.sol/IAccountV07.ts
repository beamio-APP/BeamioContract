...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IAccountV07Interface extends Interface {
  ...
  export interface IAccountV07 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IAccountV07;
    waitForDeployment(): Promise<this>;

    interface: IAccountV07Interface;
