...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IAccountV073Interface extends Interface {
  ...
  export interface IAccountV073 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IAccountV073;
    waitForDeployment(): Promise<this>;

    interface: IAccountV073Interface;
