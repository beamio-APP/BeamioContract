...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IPaymasterV073Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'validatePaymasterUserOp', data: BytesLike): Result;
  ...
  export interface IPaymasterV073 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IPaymasterV073;
    waitForDeployment(): Promise<this>;

    interface: IPaymasterV073Interface;
