...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface BeamioAccountDeployer3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'setFactory', data: BytesLike): Result;
  ...
  export interface BeamioAccountDeployer3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioAccountDeployer3;
    waitForDeployment(): Promise<this>;

    interface: BeamioAccountDeployer3Interface;
