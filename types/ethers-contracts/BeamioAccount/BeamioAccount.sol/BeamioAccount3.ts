...
export declare namespace IBeamioContainerModuleV07 {
  ...
  export interface BeamioAccount3Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'validateUserOp', data: BytesLike): Result;
  ...
  export interface BeamioAccount3 extends BaseContract {
    
    connect(runner?: ContractRunner | null): BeamioAccount3;
    waitForDeployment(): Promise<this>;

    interface: BeamioAccount3Interface;
