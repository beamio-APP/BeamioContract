...
export declare namespace IBeamioContainerModuleV07 {
  ...
  export interface IBeamioContainerModuleV073Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'simulateOpenContainer', data: BytesLike): Result;
  ...
  export interface IBeamioContainerModuleV073 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioContainerModuleV073;
    waitForDeployment(): Promise<this>;

    interface: IBeamioContainerModuleV073Interface;
