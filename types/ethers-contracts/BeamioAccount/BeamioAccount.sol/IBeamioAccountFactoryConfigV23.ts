...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface IBeamioAccountFactoryConfigV23Interface extends Interface {
...
decodeFunctionResult(functionFragment: 'quoteHelper', data: BytesLike): Result;
  ...
  export interface IBeamioAccountFactoryConfigV23 extends BaseContract {
    
    connect(runner?: ContractRunner | null): IBeamioAccountFactoryConfigV23;
    waitForDeployment(): Promise<this>;

    interface: IBeamioAccountFactoryConfigV23Interface;
